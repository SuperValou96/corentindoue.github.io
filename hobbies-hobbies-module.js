...
var HOBBIES = [
    new _hobby__WEBPACK_IMPORTED_MODULE_0__["Hobby"]('Running', 'running', 'I run on average twice a week. I started in 2012 because it is healthy and I kept practising because I like it. ' +
        ...
        new _hobby__WEBPACK_IMPORTED_MODULE_0__["Image"]('La Sainté Lyon', 'La Sainté Lyon is a mythical race which begins at Saint-Étienne and leads to Lyon. ' +
            'It is a race which starts at midnight and is 80 km long with 2,100m of elevation gain and 2,400m of elevation loss. ' +
            'In 2017 I ran it in relay with three other friends. I did the 21 last kilometers. In 2018 I will try the full one.', 'saintelyon.jpg', true),
        new _hobby__WEBPACK_IMPORTED_MODULE_0__["Image"]('Gouffre d\'Enfer dam', 'Saint-Étienne is next to the regional park of "Le Pilat", it is where I mostly run.  ' +
        ...
        new _hobby__WEBPACK_IMPORTED_MODULE_0__["Image"]('Les Deux Alpes Snow Trail', 'Last winter I participated in the Snow Trail of Les Deux Alpes ski station. ' +
    ...
    new _hobby__WEBPACK_IMPORTED_MODULE_0__["Hobby"]('Climbing', 'climbing', 'I climb on average once a week. I started in 2009 thanks to my uncle who is a climbing teacher and ' +
        ...
        new _hobby__WEBPACK_IMPORTED_MODULE_0__["Image"]('Neoliet Bolder Rotterdam', 'During my internship at Rotterdam I climbed in a bolder house named Neoliet. ' +
        ...
        new _hobby__WEBPACK_IMPORTED_MODULE_0__["Image"]('My climbing gym in Auxerre', 'I started climbing in this gym in my town (Auxerre). It is a 12 meters high wall with a lot of routes. ' +
        ...
        new _hobby__WEBPACK_IMPORTED_MODULE_0__["Image"]('Le Saussois', 'This is the nearest cliff from my parent\'s home. It is a famous climbing spot in France. ' +
            ...
            'One of the activities was this huge jump between the two cliffs, it was awesome.', 'saussois.jpg', true)
    ]),
    new _hobby__WEBPACK_IMPORTED_MODULE_0__["Hobby"]('Skiing', 'skiing', 'I ski at least twice a year. ' +
        ...
        new _hobby__WEBPACK_IMPORTED_MODULE_0__["Image"]('video', 'In 2018 I was treasurer of the ski association of the school. We organized a week at Val d\'Allos for 70 students. ' +
            'This is the aftermovie of the week.', 'https://www.youtube.com/embed/aohSbZc53NM', true),
        new _hobby__WEBPACK_IMPORTED_MODULE_0__["Image"]('Mont Blanc at Praz-sur-Arly', 'My father\'s apartment is in the little ski station of Praz-sur-Arly. I go there once a year. ' +
            'The ski area has a vue on the Mont Blanc which is in background of this picture taken in 2018.', 'praz2018montblanc.jpg', true)
    ]),
    new _hobby__WEBPACK_IMPORTED_MODULE_0__["Hobby"]('Cooking', 'cooking', 'I enjoy cooking. Even when I cook for myself I try to do something tasty and it does not bother me to spend time on it. ' +
        ...
        new _hobby__WEBPACK_IMPORTED_MODULE_0__["Image"]('Barbecue Students-Teachers', 'Once a year, the Associflard organizes a barbecue for both students and teachers of École des Mines de Saint-Étienne. ' +
            'It is a friendly moment where these two groups can exchange, gathered by the food.', 'bbq-permanenteleve2018.jpg', true),
        new _hobby__WEBPACK_IMPORTED_MODULE_0__["Image"]('Culinary Hike', 'One of the best event of the Associflard is the culinary hike. It is a hike of around 6 km in the regional park of "Le Pilat". ' +
            ...
            'What is more beautiful than walking in wonderful landscape and eating good food?', 'marchegourmande.jpg', true),
        new _hobby__WEBPACK_IMPORTED_MODULE_0__["Image"]('Floor Meal', 'In the engineering school\'s student house, we were grouped by floor. ' +
            'We often organize some meals with all the friends of the floor.', 'repasetage.jpeg', true)
    ]),
    new _hobby__WEBPACK_IMPORTED_MODULE_0__["Hobby"]('Crafting', 'crafting', 'I have always been a manual guy. I like do the things by myself. So when I need something I craft it. ' +
        ...
        new _hobby__WEBPACK_IMPORTED_MODULE_0__["Image"]('Circle bar', 'As Vice-President of the student office I participated in the organization of parties. ' +
